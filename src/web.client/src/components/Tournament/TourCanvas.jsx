...
import './TourCanvas.css';

/**
 * TourCanvas Component
...
const TourCanvas = ({ gameState, canvasWidth, canvasHeight, wallThickness}) => {
  ...
  return (
    <div className="tour-game-container">
      <canvas
        ref={staticCanvasRef}
        width={canvasWidth}
        height={canvasHeight}
